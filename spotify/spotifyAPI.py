...
from config import SPOTIFY_USERNAME, SPOTIFY_REDIRECT_URI
...
class spotifyAPI:
    ...
    def  __init__(self):
        SPOTIFY_TOKEN = util.prompt_for_user_token(SPOTIFY_USERNAME, SPOTIFY_SCOPE, client_id=SPOTIFY_CLIENT_ID, client_secret = SPOTIFY_CLIENT_SECRET, redirect_uri=SPOTIFY_REDIRECT_URI)
